...
//----------------------check if any send signal is high,if high then send everything to atmega328p by calling google api and uart function------------------------------------
...
//----------------------Serial communication between esp32 and atmega328p------------------------------------
